...
//end set_globals()
    ...
    public static function css($style = null, $media = 'all', $bypass_inheritance = FALSE, $bypass_module = FALSE) {
        $styles = array();
        $return = '';
...
//end css()
    ...
    public static function combine_css($files = array(), $media = 'all', $type = '') {
...
//end combine_css()
    ...
    public static function add_css($style = null, $media = 'all', $prepend = FALSE) {
        if (empty($style)) {
            return;
        }
...
//end add_css()
    ...
    public static function add_module_css($module, $file_path = null, $media = 'all') {
        if (empty($file_path)) {
            return;
        }
